...
def build_batch_command(
    ...
    cmd = [
        sys.executable,
        "-m",
        "rebus_generator.workflows.generate.service",
        "--sizes",
        str(size),
        "--words",
        words,
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--output-root", default="build/batch")
    ...
    parser.add_argument("--log-path", default="build/loop_runner.log")
    parser.add_argument(
        "--multi-model",
        action="store_true",
        default=True,
