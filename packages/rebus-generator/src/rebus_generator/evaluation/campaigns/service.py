...
Usage:
    python3 tools/scripts/run_prompt_campaign.py [--preset pilot] [--start-from N] [--end-at N] [--dry-run]
"""
...
from rebus_generator.evaluation.campaigns.policy import (
...
PROMPTS_DIR = PROJECT_ROOT / "packages" / "rebus-generator" / "src" / "rebus_generator" / "prompts" / "production"
...
BEST_RESULT_STATE_ROOT = PROJECT_ROOT / "build" / "evaluation" / "prompt_experiment_state"
EXPERIMENT_PRESETS = {
    "full": (1, 100),
...
# ── Prompt file paths ─────────────────────────────────────────────
SYS_DEFINITION = "definition/system.md"
SYS_VERIFY = "verify/system.md"
SYS_RATE = "rate/system.md"
SYS_REWRITE = "rewrite/system.md"
USR_GENERATE = "definition/user.md"
USR_VERIFY = "verify/user.md"
USR_RATE = "rate/user.md"
USR_REWRITE = "rewrite/user.md"
