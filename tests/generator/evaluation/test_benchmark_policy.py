...
class BenchmarkPolicyTests(unittest.TestCase):
    def test_working_baseline_is_named_but_not_hardcoded_as_metrics(self):
        self.assertEqual("baseline_results_20260329_v4exp001", WORKING_BASELINE_DESCRIPTION)
            ...
            results_path.write_text(
                "\n".join(
                    [
                        ...
                        "ccc333\t73.3\t0.300\t9.1\t8.1\tkeep\tbaseline_results_20260329_v4exp001",
                    ]
                ),
                encoding="utf-8",
            )
            ...
            self.assertEqual(
                {
                    ...
                    "avg_rebus": "8.1",
                    "status": "keep",
                    "description": "baseline_results_20260329_v4exp001",
                },
