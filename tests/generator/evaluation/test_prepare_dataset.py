...
from rebus_generator.evaluation.datasets.build_curated import (
...
class ReuseOrFetchDexTests(unittest.TestCase):
    def test_prefers_live_lookup_over_existing_stale_dataset_value(self):
        ...
        with patch("rebus_generator.evaluation.datasets.build_curated.create_provider", return_value=provider):
