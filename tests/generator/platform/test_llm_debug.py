...
from rebus_generator.workflows.redefine.service import build_parser as build_redefine_parser
from rebus_generator.workflows.redefine.repair import build_parser as build_repair_parser
from rebus_generator.workflows.retitle.service import build_parser as build_retitle_parser
from rebus_generator.cli.run_all import build_parser as build_run_all_parser
...
class DebugParserTests(unittest.TestCase):
    ...
    def test_assessment_accepts_debug(self):
        with patch("rebus_generator.evaluation.assessment.service.run_assessment") as mock_run:
            ...
            with patch("rebus_generator.evaluation.assessment.service._print_report"):
                with patch("rebus_generator.evaluation.assessment.service._append_results_tsv"):
