...
class BatchPublishTests(unittest.TestCase):
    ...
    @patch("rebus_generator.workflows.generate.prepare.choose_better_clue_variant")
    ...
    @patch("rebus_generator.workflows.generate.quality_gate.choose_better_puzzle_variant")
    ...
    @patch("rebus_generator.platform.io.rust_bridge._rust_binary_path")
    @patch("rebus_generator.platform.io.rust_bridge.subprocess.run")
    ...
    @patch("rebus_generator.workflows.generate.prepare.random.choice")
    ...
    def test_overnight_loop_sizes_include_fifteen(self):
        from rebus_generator.domain.size_tuning import OVERNIGHT_LOOP_SIZES
    ...
    def test_plateau_constants(self):
        from rebus_generator.domain.score_helpers import PLATEAU_LOOKBACK
