...
class RepairPuzzleTests(unittest.TestCase):
    @patch("rebus_generator.workflows.redefine.repair.score_puzzle_state")
    @patch("rebus_generator.workflows.redefine.repair.run_rewrite_loop")
    @patch("rebus_generator.workflows.redefine.repair.evaluate_puzzle_state")
    ...
    @patch(
        "rebus_generator.workflows.redefine.repair.generate_creative_title_result",
