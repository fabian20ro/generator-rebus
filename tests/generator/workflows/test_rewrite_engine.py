...
class RewriteEngineTests(unittest.TestCase):
    ...
    @patch("rebus_generator.workflows.redefine.rewrite_engine.rate_working_puzzle")
    @patch("rebus_generator.workflows.redefine.rewrite_engine.verify_working_puzzle")
    @patch("rebus_generator.workflows.redefine.rewrite_engine.rewrite_definition")
    @patch("rebus_generator.workflows.redefine.rewrite_engine.LmRuntime")
    ...
    @patch("rebus_generator.workflows.redefine.rewrite_engine.LmRuntime")
    @patch("rebus_generator.workflows.redefine.rewrite_engine.generate_definition")
    @patch("rebus_generator.workflows.redefine.rewrite_engine.rewrite_definition")
    @patch("rebus_generator.workflows.redefine.rewrite_engine.rate_working_puzzle")
    @patch("rebus_generator.workflows.redefine.rewrite_engine.verify_working_puzzle")
