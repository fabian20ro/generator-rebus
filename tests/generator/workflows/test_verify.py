...
from rebus_generator.platform.llm.ai_clues import DefinitionRating, contains_english_markers
...
class VerifyPhaseTests(unittest.TestCase):
    ...
    @patch(
        "rebus_generator.workflows.generate.verify.LmRuntime.activate_secondary",
